...
export default {
  ...
  updatePassword(id, newPassword) {
    return db('accounts').where('ID', id).update({ Hashed_password: newPassword })
  },
  ...
  updateWard(id, locationName) {
    return db('accounts').where('ID', id).update({ Ward: locationName })
  },
  updateDistrict(id, locationName) {
    return db('accounts').where('ID', id).update({ District: locationName })
  },
  del(id) {
